...
# def load_df_votacao(turno, estado=None, usecols="*"):
#     ################################
#     # link pros dados
...
#     ESTADO_FILENAME = f"data/votacao_secao_2022_BR/votacao_secao_2022_{estado}.csv"
#
#     if estado and os.path.exists(ESTADO_FILENAME):
#         dfv = pd.read_csv(ESTADO_FILENAME, encoding='latin1',
#                            sep=";", dtype=DFV_DTYPE)
#
#     elif estado and not os.path.exists(ESTADO_FILENAME):
#         dfv = pd.read_csv(FILEPATH,
#                            encoding='latin1', sep=";", dtype=DFV_DTYPE)
#         dfv = dfv[dfv["SG_UF"] == estado]
#         dfv["NM_MUNICIPIO"] = dflib.remove_acento_list(dfv["NM_MUNICIPIO"].str.upper())
#
#         dfv.to_csv(ESTADO_FILENAME,
#                     encoding='latin1', sep=";", dtype=DFV_DTYPE)
#
#     else:
#         dfv = pd.read_csv(FILEPATH,
...
# def load_df_votacao_boletim_urna_presidente(turno, estado=None, usecols="*"):
#     ################################
#     # link pros dados
#     # https://dadosabertos.tse.jus.br/dataset/resultados-2022-boletim-de-urna
#
#     FILEPATH = "data/bus/presidente.csv"
#     ESTADO_FILENAME = f"data/bus/processados_estado/presidente_{estado}.csv"
#
#     if estado and os.path.exists(ESTADO_FILENAME):
#         dfbu = pd.read_csv(ESTADO_FILENAME, encoding='latin1',
#                            sep=";", dtype=DFV_DTYPE)
#
#     elif estado and not os.path.exists(ESTADO_FILENAME):
#         dfbu = pd.read_csv(FILEPATH,
#                            encoding='latin1', sep=";", dtype=DFV_DTYPE)
#         dfbu = dfbu[dfbu["SG_UF"] == estado]
#         dfbu["NM_MUNICIPIO"] = dflib.remove_acento_list(dfbu["NM_MUNICIPIO"].str.upper())
#
#         dfbu.to_csv(ESTADO_FILENAME,
#                     encoding='latin1', sep=";", dtype=DFV_DTYPE)
#
#     else:
#         dfbu = pd.read_csv(FILEPATH,
